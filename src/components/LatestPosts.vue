    ...
    <div>
        <div class="row">
            <div class="col-md-6" v-for="post in posts" :key="post.id">
                <a href="blog-single.html" class="blog-entry element-animate fadeIn element-animated"
                    data-animate-effect="fadeIn">
                    <img :src="'http://127.0.0.1:8000/' + post.image" alt="Image placeholder">
...
<script>
    export default {
        ...
        methods: {
            getLatestPosts() {
                this.axios.get('http://127.0.0.1:8000/api/latestPosts', {
                    method: 'get'
                }).then(response => {
